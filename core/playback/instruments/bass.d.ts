...
export declare class BassInstrument implements VmmxInstrument<BassString, BassDropEvent> {
    private bassStore;
    readonly channels: Record<BassString, BassStringChannel>;
    constructor(bassStore: BassStore);
    onToneLoad(): void;
    addNoteFromEvent(event: BassDropEvent & TickedDropEvent): void;
}
export declare class BassStringChannel implements VmmxInstrumentChannel {
    private stringStore;
    private bassSynth?;
