...
import { VibraphoneDropEvent, TickedDropEvent, VibraphoneChannel } from "vmmx-schema";
export declare class VibraphoneInstrument implements VmmxInstrument<VibraphoneChannel, VibraphoneDropEvent> {
    ...
    onToneLoad(): void;
    addNoteFromEvent(event: VibraphoneDropEvent & TickedDropEvent): void;
}
export declare class VibraphoneBarChannel implements VmmxInstrumentChannel {
    private barStore;
    private channelSynth?;
    readonly channelPart: ChannelPart;
