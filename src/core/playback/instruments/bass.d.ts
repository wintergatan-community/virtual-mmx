...
export declare class BassInstrument implements VmmxInstrument<BassString, BassDropE> {
    private bassStore;
    readonly channels: Record<BassString, BassStringChannel>;
    constructor(appStore: AppStore, bassStore: BassStore);
    onToneLoad(): void;
}
export declare class BassStringChannel extends VmmxInstrumentChannel<BassDropE> {
    private appStore;
    private stringStore;
    private bassSynth?;
    ...
    triggerStrike: (_?: BassDropE | undefined, time?: number | undefined) => void;
}
